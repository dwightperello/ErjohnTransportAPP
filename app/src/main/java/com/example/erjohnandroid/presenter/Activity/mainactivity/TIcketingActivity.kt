            ...
            try {
                if (passtype == "Baggage" && _binding.cbBaggage.isChecked) {
                    ...
                    else
                    {
                        ...
                        var returned= computePitxFare(destination?.kmPoint!!,origin?.kmPoint!!,GlobalVariable.basefair,passtype!!,_binding.btnPrintticke)
                        total= returned.fare
                        KMdiff=returned.kmDiff
                        kmdiffprint= returned.kmDiff
                    }
